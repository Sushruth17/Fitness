...
import kotlinx.android.synthetic.main.unit_detailed_exercise.view.*
import kotlinx.android.synthetic.main.unit_story.view.*


class DetailedExerciseAdapter: RecyclerView.Adapter<DetailedExerciseAdapter.ViewHolder>(){


        class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            val count: TextView = itemView.listItem
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            ...
            view = ViewHolder(LayoutInflater.from(parent.context).inflate
                            (R.layout.unit_detailed_exercise, parent, false))
        return view
    }
